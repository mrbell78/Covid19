 ...
 */
public class DoctorrequestitemFragment extends Fragment {
    ...
    public DoctorrequestitemFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = LayoutInflater.from(getContext()).inflate(R.layout.fragment_doctorrequestitem,container,false);
